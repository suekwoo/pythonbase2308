# -*- coding: utf-8 -*-
"""
Created on Tue Aug 29 11:44:43 2023
...
df4 = df.copy()
df4
df4.rename(index={"홍길동":"aaaaaa"},inplace=True)
...
=> data/sales_2015.xlsx 파일에서 january_2015 sheet 데이터
  읽기. 인덱스 컬럼 설정 안함.
...
for name,data in df.items() :
    ...
    if i == 0 :
       ...
       dfall = pd.concat([dfall, data], axis=0)  #row로 합침
       # axio = 0 index(row), 1 column
    i=i+1

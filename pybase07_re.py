# -*- coding: utf-8 -*-
"""
Created on Mon Aug 28 14:06:58 2023
...
#       The ,Te, Thhhhhhe
pattern = re.compile("Th*e") #패턴 객체 설정  h가 0개이상인 문자열
count = 0
...
print(tlist)
print(sum(tlist)/len(tlist)) #25.5

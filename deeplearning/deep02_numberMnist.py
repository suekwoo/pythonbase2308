# -*- coding: utf-8 -*-
"""
Created on Mon Sep 18 11:09:51 2023
...
model.add(Dense(10,activation="softmax")) #0 ~ 9 10개
model.summary()
'''
  1층 : 
    64 : 출력노드 갯수   
...
'''
#학습하기
history=model.fit(x_train,y_train,epochs=10,batch_size=127,
